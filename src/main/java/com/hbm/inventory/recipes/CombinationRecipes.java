...
public class CombinationRecipes extends SerializableRecipe {
    ...
    @Nullable
    public static Pair<@Nullable ItemStack, FluidStack> getOutput(@NotNull ItemStack stack) {
    ...
    public void registerDefaults() {
        ...
        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.briquette, EnumBriquetteType.COAL)),
                new Pair<>(DictFrame.fromOne(ModItems.coke, EnumCokeType.COAL), new FluidStack(Fluids.COALCREOSOTE, 150)));
        ...
        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.briquette, EnumBriquetteType.WOOD)),
                new Pair<>(new ItemStack(Items.COAL, 1, 1), new FluidStack(Fluids.WOODOIL, 500)));

        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.oil_tar, EnumTarType.CRUDE)),
                new Pair<>(DictFrame.fromOne(ModItems.coke, EnumCokeType.PETROLEUM), null));
        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.oil_tar, EnumTarType.CRACK)),
                new Pair<>(DictFrame.fromOne(ModItems.coke, EnumCokeType.PETROLEUM), null));
        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.oil_tar, EnumTarType.COAL)),
                new Pair<>(DictFrame.fromOne(ModItems.coke, EnumCokeType.COAL), null));
        recipes.put(new ComparableStack(DictFrame.fromOne(ModItems.oil_tar, EnumTarType.WOOD)),
                new Pair<>(DictFrame.fromOne(ModItems.coke, EnumCokeType.COAL), null));
        ...
        for (BedrockOreType type : BedrockOreType.VALUES) {
            ...
            recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY, type)),
                    new Pair<>(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_ROASTED, type), new FluidStack(Fluids.VITRIOL, 50)));
            recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.SULFURIC_BYPRODUCT, type)),
                    new Pair<>(ItemBedrockOreNew.make(BedrockOreGrade.SULFURIC_ROASTED, type), new FluidStack(Fluids.VITRIOL, 50)));
            recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.SOLVENT_BYPRODUCT, type)),
                    new Pair<>(ItemBedrockOreNew.make(BedrockOreGrade.SOLVENT_ROASTED, type), new FluidStack(Fluids.VITRIOL, 50)));
            recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.RAD_BYPRODUCT, type)),
                    new Pair<>(ItemBedrockOreNew.make(BedrockOreGrade.RAD_ROASTED, type), new FluidStack(Fluids.VITRIOL, 50)));
        }
    }
